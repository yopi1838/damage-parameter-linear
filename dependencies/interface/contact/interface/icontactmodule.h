...
namespace itascaxd {
    ...
    public:
        ...
        virtual IAllContactContainer *getAllContactContainer(const QString &className,bool throwException=true)=0;
        // Get a const pointer to the allcontactcontainer for the specified contact class name
        virtual const IAllContactContainer *getAllContactContainer(const QString &className,bool throwException=true) const=0;
        // Get a pointer to the contactmodellist for the specified contact class name
        virtual IContactModelList *getContactModelList(const QString &className,bool throwException=true)=0;
        // Get a const pointer to the contactmodellist for the specified contact class name
        virtual const IContactModelList *getContactModelList(const QString &className,bool throwException=true) const=0;
